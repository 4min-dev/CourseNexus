              ...
              <CardContent className="space-y-6">
                  ...
                  <div className="max-w-md">
                    ...
                    <div className="bg-card border border-border rounded-lg p-4 space-y-3 hover-elevate transition-all">
                      ...
                      <div className="space-y-2">
                        <p className="text-sm text-muted-foreground" data-testid="text-telegram">@kurs_helper</p>
                        <Button
                          variant="outline"
                          size="sm"
                          className="w-full"
                          onClick={() => window.open('https://t.me/kurs_helper', '_blank')}
                ...
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 space-y-2" data-testid="section-response-time">
                  ...
                  <p className="text-sm text-muted-foreground" data-testid="text-response-time">
                    Мы стремимся отвечать на все обращения в течение <strong className="text-foreground">15 – 30 мин</strong> в рабочие дни.
